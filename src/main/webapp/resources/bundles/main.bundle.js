...
exports.WEB_PLATFORM = self.parent['WEB_PLATFORM'];
if (!exports.WEB_PLATFORM) {
    exports.WEB_PLATFORM = self.parent.document.getElementById("container_app") || {};
    self.parent['WEB_PLATFORM'] = exports.WEB_PLATFORM;
    // The web context starts with a different root path depending on which client is running.
    if (!exports.WEB_PLATFORM.getRootPath) {
        exports.WEB_PLATFORM.getRootPath = function () { return "/vsphere-client"; };
    }
    // Declare unknown client type explicitly.
    if (!exports.WEB_PLATFORM.getClientType) {
        exports.WEB_PLATFORM.getClientType = function () { return "flex"; };
    }
    // Declare unknown client version explicitly.
    if (!exports.WEB_PLATFORM.getClientVersion) {
        exports.WEB_PLATFORM.getClientVersion = function () { return "6.0"; };
    }
}
if (!exports.com_mycompany_vcpui) {
    exports.com_mycompany_vcpui = {};
    // The web context path to use for server requests, compatible with Flex and HTML clients
    exports.com_mycompany_vcpui.webContextPath = exports.WEB_PLATFORM.getRootPath() + "/vcpui";
    ...
    (function () {
        // Namespace shortcut
        var ns = exports.com_mycompany_vcpui;
        // ------------------------ Private functions -------------------------------
        // Get a string from the resource bundle defined in plugin.xml
        function getString(key, params) {
            return exports.WEB_PLATFORM.getString("com_mycompany_vcpui", key, params);
        }
        ...
        exports.WEB_PLATFORM.setGlobalRefreshHandler = function (handler) {
            exports.WEB_PLATFORM["refresh" + window.name] = handler;
        };
    })();
} // end of if (!com_mycompany_vcpui)
//# sourceMappingURL=D:/workspace/VCP-UI/src/web-platform.js.map
...
var Rx_1 = __webpack_require__(215);
...
var keys_1 = __webpack_require__(672);
 ...
 */
var core_1 = __webpack_require__(0);
var datacenter_component_config_1 = __webpack_require__(660);
var index_1 = __webpack_require__(88);
var router_1 = __webpack_require__(30);
var index_2 = __webpack_require__(106);
 ...
 */
var core_1 = __webpack_require__(0);
var host_component_config_1 = __webpack_require__(667);
var index_1 = __webpack_require__(88);
var index_2 = __webpack_require__(106);
...
var post_service_1 = __webpack_require__(107);
 ...
 */
var core_1 = __webpack_require__(0);
var cluster_component_config_1 = __webpack_require__(657);
var index_1 = __webpack_require__(88);
var router_1 = __webpack_require__(30);
var index_2 = __webpack_require__(106);
 ...
 */
var core_1 = __webpack_require__(0);
var global_component_config_1 = __webpack_require__(665);
var index_1 = __webpack_require__(88);
...
var GLOBALComponent = (function () {
    ...
    GLOBALComponent.prototype.onSelectionChanged = function (data) {
        console.log(data);
    };
    GLOBALComponent.prototype.loadVolumeInfo = function (data) {
        var _this = this;
        this._tmpPieChartData = index_2._tmpPieChartDatafn();
        this._tmpBarChart = index_2._tmpMultiBarChartDatafn();
        this._tmpAreaChartData = index_2._tmpMultiAreaChartDatafn();
        this.service.getEventsLst(data, global_component_config_1.GlobalConfig.eventsServiceProvider)
            .subscribe(function (data) {
            _this.extendGridOptions.rowData = data;
            _this._volumeLst = data;
        }, function (err) {
            _this.extendGridOptions.rowData = [];
        });
    };
    ...
    GLOBALComponent.prototype.getVoumeItemSummary = function (vName) {
        this._volumeItemSummary = this._volumeLst.filter(function (d) {
            return d['name'] === vName ? d : null;
        })[0] || {};
        this._volumeItemSummary['capacityGraphData'] = this.getPieChartData(this._volumeItemSummary['capacity']);
    };
...
var core_1 = __webpack_require__(0);
var router_1 = __webpack_require__(30);
var areaChart_component_config_1 = __webpack_require__(638);
var post_service_1 = __webpack_require__(107);
...
var core_1 = __webpack_require__(0);
var performanceListView_component_config_1 = __webpack_require__(643);
var router_1 = __webpack_require__(30);
var post_service_1 = __webpack_require__(107);
...
var core_1 = __webpack_require__(0);
var index_1 = __webpack_require__(88);
var login_component_config_1 = __webpack_require__(646);
...
var core_1 = __webpack_require__(0);
var platform_browser_1 = __webpack_require__(35);
var index_1 = __webpack_require__(661);
var main_1 = __webpack_require__(108);
 ...
 */
var core_1 = __webpack_require__(0);
var datastore_component_config_1 = __webpack_require__(663);
var index_1 = __webpack_require__(88);
//TODO remove after integrating with service
var index_2 = __webpack_require__(106);
...
var platform_browser_dynamic_1 = __webpack_require__(604);
...
var AppComponent = (function () {
    ...
    AppComponent = __decorate([
        core_1.Component({
            selector: 'my-app',
            template: "      \n    <section>\n      <img alt=\"Tintri Logo\" src=\"https://www.tintri.com/sites/all/themes/tt/logo.png\" class=\"logo flRight\" typeof=\"foaf:Image\">                                                                                                                                     \n      <section class=\"layout-content\">\n        <router-outlet></router-outlet>\n      </section>\n    </section>\n    <login-form (hidePopUp)=\"hideLoginForm($event)\"  class=\"flLeft\" [ngClass]=\"{'hide': (isAuthenticated || hideDialog)}\" id=\"login-form\" [shouldAuthenticated] = '!isAuthenticated'></login-form>\n  ",
            providers: [index_1.AuthenticationService]
        }), 
...
var http_1 = __webpack_require__(103);
var app_routes_1 = __webpack_require__(637);
var app_component_1 = __webpack_require__(635);
var appHeader_component_1 = __webpack_require__(423);
// used to create fake backend
var index_1 = __webpack_require__(648);
var testing_1 = __webpack_require__(393);
var http_2 = __webpack_require__(103);
var global_module_1 = __webpack_require__(138);
var cluster_module_1 = __webpack_require__(428);
var app_routing_module_1 = __webpack_require__(634);
var datacenter_module_1 = __webpack_require__(429);
var shared_module_1 = __webpack_require__(87);
var datastore_module_1 = __webpack_require__(431);
var host_module_1 = __webpack_require__(434);
var summary_module_1 = __webpack_require__(671);
var multiBarChart_component_1 = __webpack_require__(418);
var datacenterwizard_component_1 = __webpack_require__(191);
var datacenterwizard_module_1 = __webpack_require__(641);
var progressindicator_component_1 = __webpack_require__(137);
var common_1 = __webpack_require__(37);
var web_platform_1 = __webpack_require__(1062);
    ...
    AppModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [
                ...
                web_platform_1.WEB_PLATFORM,
                web_platform_1.com_mycompany_vcpui,
...
var core_1 = __webpack_require__(0);
var datacenterwizard_routing_module_1 = __webpack_require__(640);
var platform_browser_1 = __webpack_require__(35);
...
var core_1 = __webpack_require__(0);
var index_1 = __webpack_require__(106);
...
"use strict";
//Temp file need to remove once service is integrated

var http_1 = __webpack_require__(103);
var testing_1 = __webpack_require__(393);
var userCredentials_1 = __webpack_require__(426);
var storageArrayDeviceLst_1 = __webpack_require__(650);
var eventsLst_1 = __webpack_require__(649);
var utils_1 = __webpack_require__(427);
var uuidV1 = __webpack_require__(1056);
...
exports.fakeBackendProvider = {
    ...
    useFactory: function (backend, options) {
        ...
        backend.connections.subscribe(function (connection) {
            ...
            setTimeout(function () {
                // authenticate
                if (connection.request.url.endsWith(userCredentials_1.url) && connection.request.method == http_1.RequestMethod.Post) {
                    // get parameters from post request
                    // find if any user matches login credentials
                    var filteredUsers = userCredentials_1.UserCredentials.filter(function (user) {
                        return user.userName === params.userName && user.password === params.password && user.hostName === params.hostName;
                    });
                ...
                else if ((connection.request.url.endsWith(storageArrayDeviceLst_1.globalURL) || connection.request.url.endsWith(storageArrayDeviceLst_1.ClusterURL)) && connection.request.method == http_1.RequestMethod.Post) {
                    // get parameters from post request
                    // find if any user matches login credentials
                    var filteredUsers = userCredentials_1.UserCredentials.filter(function (user) {
                        return user.userName === params.userName && user.hostName === params.hostName;
                    });
                    if (filteredUsers.length) {
                        // if login details are valid return 200 OK with user details and fake jwt token
                        var user = filteredUsers[0];
                        connection.mockRespond(new http_1.Response(new http_1.ResponseOptions({
                            status: 200,
                            body: storageArrayDeviceLst_1.genStroageDeviceLst(50) || []
                        })));
                    }
                    else {
                        // else return 400 bad request
                        connection.mockError(new Error('could\'t able to retrieve device list info'));
                    }
                }
                else if ((connection.request.url.endsWith(eventsLst_1.eventUrl)) && connection.request.method == http_1.RequestMethod.Post) {
                    // get parameters from post request
                    if (params.hasOwnProperty('uuid')) {
                        connection.mockRespond(new http_1.Response(new http_1.ResponseOptions({
                            status: 200,
                            body: eventsLst_1.genEventsLst(40) || []
                        })));
                    }
                    else {
                        // else return 400 bad request
                ...
                else if ((connection.request.url.endsWith(storageArrayDeviceLst_1.VolumeURL)) && connection.request.method == http_1.RequestMethod.Post) {
                    // get parameters from post request
                    if (params.hasOwnProperty('uuid')) {
                        connection.mockRespond(new http_1.Response(new http_1.ResponseOptions({
                            status: 200,
                            body: storageArrayDeviceLst_1.genVoumeMappingLst(30) || []
                        })));
                    }
                    else {
                        // else return 400 bad request
                ...
                else if ((connection.request.url.endsWith(storageArrayDeviceLst_1.ThroughOPURL) || connection.request.url.endsWith(storageArrayDeviceLst_1.iOPURL)) && connection.request.method == http_1.RequestMethod.Post) {
                    connection.mockRespond(new http_1.Response(new http_1.ResponseOptions({
                        status: 200,
                        body: utils_1._tmpAreaChartDatafn((params && params.payload && params.payload.id) || "N/A") || []
                    })));
                }
                else if ((connection.request.url.endsWith(storageArrayDeviceLst_1.tintriPerfURL)) && connection.request.method == http_1.RequestMethod.Post) {
                    connection.mockRespond(new http_1.Response(new http_1.ResponseOptions({
                        status: 200,
                        body: storageArrayDeviceLst_1.genTinTriPerfList()
                    })));
                }
            }, 500);
        });
...
//# sourceMappingURL=D:/workspace/VCP-UI/src/dbService.js.map
    ...
    6438482: [
        {
            ...
            messLevel: "Added host Esx1 & Exs2 to host group EsxGroup HOST",
            eventLabel: "Configure & Masking"
        },
        {
            serverTime: (function () {
                return Date.now();
            })(),
            messLevel: "Host Group EsxGroup was created with host: No Hosts",
            eventLabel: "Host & Configure"
        },
        {
            serverTime: (function () {
                return Date.now();
...
exports.genEventsLst = function (len) {
    var _result = [];
    while (len--) {
        _result.push({
            serverTime: (new Date(Date.now() - (Math.random() * 1000000))).toUTCString(),
            messLevel: "Host Group EsxGroup was created with host: No Hosts",
            eventLabel: "Host & Configure"
        });
    }
...
exports.eventUrl = "/api/getEventsByCluster";
//# sourceMappingURL=D:/workspace/VCP-UI/src/eventsLst.js.map
...
var uuid = __webpack_require__(762);
exports.genStroageDeviceLst = function (len) {
    var _result = [];
    while (len--) {
        var _capTotal = Math.random() * 100, _occupied = Math.floor(Math.random() * (_capTotal + 1));
        _result.push({
            uuid: uuid.v1(),
            deviceName: 'K2-' + uuid.v4().split('-')[0],
            state: 'online',
            errEvents: 'No Errors in last 2 days',
            connectedHost: Math.floor(Math.random() * (_capTotal + 1)),
            capacity: {
                totalVolume: parseFloat(_capTotal.toFixed(2)),
                occupied: parseFloat(_occupied.toFixed(2)),
                conversion: 'TB'
            },
            Host: []
        });
...
exports.genVoumeMappingLst = function (len) {
    var _result = [];
    while (len--) {
        var _capTotal = Math.random() * 100, _occupied = Math.floor(Math.random() * (_capTotal + 1));
        _result.push({
            name: "VG" + (Math.floor(Math.random() * (5 - 1 + 1)) + 1) + ":ds1",
            size: (Math.floor(Math.random() * (1024 - 1 + 1)) + 0.512) + "GB",
            dataStore: "datastore-1***",
            Dedup: "yes",
            Host: [],
            naa: "naa" + uuid.v1().split('-')[0],
            performance: [],
            capacity: {
                totalVolume: parseFloat(_capTotal.toFixed(2)),
                occupied: parseFloat(_occupied.toFixed(2)),
                free: Math.floor(_capTotal - _occupied),
                conversion: 'TB'
            }
        });
    }
...
exports.genTinTriPerfList = function () {
    var _result = {};
    _result['hitRate'] = (Math.floor(Math.random() * (100 - 10 + 1)) + 10);
    _result['IOPs'] = ((Math.floor(Math.random() * (1000 - 100 + 1)) + 100) / 1000) + "  IOPs";
    _result['ThroughOP'] = ((Math.floor(Math.random() * (1000 - 100.50 + 1)) + 100.50) / 1000) + "   MbPS";
    _result['Latency'] = ((Math.floor(Math.random() * (1000 - 100.50 + 1)) + 100.50) / 1000) + "  ms";
    return _result;
};
exports.globalURL = '/api/getStorageLst';
exports.VolumeURL = '/api/getVolumeMappingLst';
exports.ClusterURL = '/api/getClusterDeviceLst';
exports.ThroughOPURL = '/api/getAreaChartDummyThroughOP';
exports.iOPURL = '/api/getAreaChartDummyiOP';
exports.tintriPerfURL = '/api/getTintriPerf';
//# sourceMappingURL=D:/workspace/VCP-UI/src/storageArrayDeviceLst.js.map
...
exports.eventLstColumnDefs = [
    { headerName: "Server Time", field: "serverTime" },
    { headerName: "Level Message", field: "messLevel" },
    { headerName: "Labels", field: "eventLabel" }
];
...
var core_1 = __webpack_require__(0);
var platform_browser_1 = __webpack_require__(35);
var summary_routing_module_1 = __webpack_require__(670);
var summary_component_1 = __webpack_require__(435);
var shared_module_1 = __webpack_require__(87);
